...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.Slit_Size.setEnabled(self.a)
        ...
        self.Slit_Separation.setEnabled(self.b)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Slit_Option.setItemText(
            3, _translate("Simulator", "MULTIPLE SLIT"))
        self.Slit_Option.setItemText(
            4, _translate("Simulator", "MULTIPLE POINT"))
        self.Slit_Option.setItemText(
...
# GUI settings End:
    ...
    def main():
        ...
        if Slit_option == 'SINGLE SLIT':
        ...
        elif Slit_option == 'MULTIPLE SLIT':
            pass

        elif Slit_option == 'MULTIPLE POINT':
            class case4(configurator):
                ...
                def create_slit(self, slt_sz, slt_sep, slt_res, scr_sz, scr_res):
                    ...
                    self.Slit_Grid = int(slt_sep/slt_res)
                    self.factor1 = scr_res/slt_sep

                    Slit = []
                    for i in range(1):
                        Slit.append([Slit]*(2*self.Slit_Grid + 1))
                        Slit[i][0] = I0
                        Slit[i][self.Slit_Grid + 1] = I0
                        Slit[i][-1] = I0
                    self.slit = Slit
                    return self.slit
        ...
        def func(x_point, y_point):
            ...
            for i in range(len(Slit)):
                for j in range(len(Slit[0])):
                    if Slit[i][j] != 0.0:
                        R = [x_point*Screen_Resoution-j*Slit_Plane_Resolution*0.001,
                             y_point*Screen_Resoution-i*Slit_Plane_Resolution*0.001, Distance*10]
                        T += W.Wave_eq(R)
            I = np.dot(T, T)
            return(I)
